...
(function(){
  ...
  const PEOPLE = [
    ...
    {id:'BL-0417', nm:'Patricia Núñez', doc:'CURP NUPP9102', tel:'+52 322 778 1245', pos:'Recepción', zona:'Este', m:'grave',   fecha:'06 may 2026', by:'Carlos Méndez', byrl:'Manager de Reclutamiento'},
    ...
    {id:'BL-0415', nm:'Lorena Castillo', doc:'CURP CALL9433', tel:'+52 322 556 7781', pos:'Cocina', zona:'Noroeste',   m:'faltas',  fecha:'01 may 2026', by:'Ana Torres', byrl:'Reclutadora · Zona Noroeste', faltas:[{d:'14 abr',s:'No se presentó · Las Palmas'},{d:'21 abr',s:'Inasistencia sin aviso · Las Palmas'},{d:'28 abr',s:'3ª inasistencia — escalado automático'}]},
    {id:'BL-0414', nm:'Hugo Pereira', doc:'CURP PEHH8821', tel:'+52 322 334 9012', pos:'Botones', zona:'Este', m:'grave',   fecha:'28 abr 2026', by:'Carlos Méndez', byrl:'Manager de Reclutamiento'},
    {id:'BL-0413', nm:'Daniela Fuentes', doc:'CURP FUDD9567', tel:'+52 322 612 4458', pos:'Camarista', zona:'Sur',  m:'faltas', fecha:'25 abr 2026', by:'Ana Torres', byrl:'Reclutadora · Zona Noroeste', faltas:[{d:'08 abr',s:'No se presentó · Bahía Príncipe'},{d:'15 abr',s:'Inasistencia sin aviso'},{d:'22 abr',s:'3ª inasistencia — escalado automático'}]},
    {id:'BL-0412', nm:'Iván Salgado', doc:'CURP SAII8690', tel:'+52 322 845 7723', pos:'Mantenimiento', zona:'Centro', m:'faltas', fecha:'22 abr 2026', by:'Ana Torres', byrl:'Reclutadora · Zona Noroeste', faltas:[{d:'05 abr',s:'No se presentó · Costa del Sol'},{d:'12 abr',s:'Inasistencia sin aviso'},{d:'19 abr',s:'3ª inasistencia — escalado automático'}]},
    {id:'BL-0411', nm:'Mariana Ortiz', doc:'CURP ORMM9248', tel:'+52 322 190 6634', pos:'Recepción', zona:'Oeste', m:'grave', fecha:'18 abr 2026', by:'QA · Operaciones', byrl:'Control de calidad'},
    {id:'BL-0410', nm:'Sergio Beltrán', doc:'CURP BESS8377', tel:'+52 322 477 2218', pos:'Mesero (A&B)', zona:'Este', m:'faltas', fecha:'15 abr 2026', by:'Ana Torres', byrl:'Reclutadora · Zona Noroeste', faltas:[{d:'29 mar',s:'No se presentó · Marea Azul'},{d:'05 abr',s:'Inasistencia sin aviso'},{d:'12 abr',s:'3ª inasistencia — escalado automático'}]},
    {id:'BL-0409', nm:'Verónica Lara', doc:'CURP LAVV9711', tel:'+52 322 663 5590', pos:'Cocina', zona:'Noroeste', m:'faltas', fecha:'11 abr 2026', by:'Ana Torres', byrl:'Reclutadora · Zona Noroeste', faltas:[{d:'25 mar',s:'No se presentó · Las Palmas'},{d:'01 abr',s:'Inasistencia sin aviso'},{d:'08 abr',s:'3ª inasistencia — escalado automático'}]},
    ...
    {id:'BL-0407', nm:'Claudia Rentería', doc:'CURP RECC9082', tel:'+52 322 519 3376', pos:'Camarista', zona:'Sur', m:'faltas', fecha:'02 abr 2026', by:'Ana Torres', byrl:'Reclutadora · Zona Noroeste', faltas:[{d:'16 mar',s:'No se presentó · Vista Mar'},{d:'23 mar',s:'Inasistencia sin aviso'},{d:'30 mar',s:'3ª inasistencia — escalado automático'}]},
    ...
    {id:'BL-0405', nm:'Teresa Aguirre', doc:'CURP AGTT9610', tel:'+52 322 365 8842', pos:'Cocina', zona:'Este', m:'grave', fecha:'26 mar 2026', by:'QA · Operaciones', byrl:'Control de calidad'},
    {id:'BL-0404', nm:'Jorge Villanueva', doc:'CURP VIJJ8519', tel:'+52 322 902 6677', pos:'Mantenimiento', zona:'Noroeste', m:'faltas', fecha:'21 mar 2026', by:'Ana Torres', byrl:'Reclutadora · Zona Noroeste', faltas:[{d:'04 mar',s:'No se presentó · Puerto Sereno'},{d:'11 mar',s:'Inasistencia sin aviso'},{d:'18 mar',s:'3ª inasistencia — escalado automático'}]},
    {id:'BL-0403', nm:'Pilar Cervantes', doc:'CURP CEPP9374', tel:'+52 322 158 4420', pos:'Mesero (A&B)', zona:'Oeste', m:'grave', fecha:'17 mar 2026', by:'Carlos Méndez', byrl:'Manager de Reclutamiento'},
  ];
  ...
  const POOL = [
    ...
    {nm:'Alberto Quiroz',   doc:'CURP QUAA8801', pos:'Mesero · Zona Este',         st:'amarillo'},
    {nm:'Natalia Vega',     doc:'CURP VENN9476', pos:'Recepción · Zona Noroeste',        st:'naranja'},
    ...
    {nm:'Emilio Carrasco',  doc:'CURP CAEE8744', pos:'Mantenimiento · Zona Oeste', st:'azul'},
    {nm:'Lucía Mendoza',    doc:'CURP MELL9320', pos:'Botones · Zona Este',        st:'blanco'},
    {nm:'Diego Salas',      doc:'CURP SADD9087', pos:'Steward · Zona Noroeste',          st:'rosa'},
    ...
    {nm:'Sofía Lara',       doc:'CURP LASS8741', pos:'Recepción · Zona Este',      st:'gris'},
  ];
  ...
  const INSPECTORES = { Centro:'Roberto Salinas', Sur:'Renata Páez', Este:'Diego Fuentes', Oeste:'Héctor Villalba', Noroeste:'Mónica Ibarra', Sureste:'Laura Bravo' };
    ...
    root.innerHTML = `
      ...
      <div class="recl-hero">
        <div class="recl-hero-left" style="height:160px;background:radial-gradient(135% 150% at 88% 6%, rgba(255,122,0,.32) 0%, rgba(255,122,0,0) 52%), linear-gradient(135deg,#4A3216 0%,#2C1D0F 55%,#1A1108 100%)">
          <div class="eyebrow"><span class="pulse"></span>Control de calidad · Vetados del departamento</div>
          <h1>Colaboradores <span class="accent">vetados</span> de la plataforma.</h1>
          <div class="lead">Consulta global de la blacklist del departamento, su motivo y quién lo propuso. Cualquier rol de Reclutamiento puede agregar con su justificación. El veto es permanente; las disputas las resuelve el Inspector de zona.</div>
        </div>
  ...
  window.__blAddConfirm = ()=>{
    ...
    PEOPLE.unshift({
      ...
      by:'Carlos Méndez', byrl:'Manager de Reclutamiento', regCat:'manager', regName:'Carlos Méndez', regRole:'Manager de Reclutamiento',
      hotel:'Hotel asignado', reporter:{name:'Carlos Méndez', role:'Manager de Reclutamiento'}, inspector:'Inspector de zona'
    });
